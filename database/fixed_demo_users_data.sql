-- ============================================================
-- FIXED DEMO USERS AND DATA SETUP
-- This script creates demo users without password_hash column
...
-- ============================================================
-- 1. CREATE DEMO USERS (without password_hash)
-- ============================================================
...
-- Insert demo users (without password_hash - you'll need to set passwords via auth system)
INSERT INTO users (
    id,
    email,
    role,
...
RAISE NOTICE '🎉 DEMO SETUP COMPLETE (without password_hash)!';
...
This script creates users WITHOUT passwords since the users table 
doesn't have a password_hash column.
...
DEMO USER EMAILS:
✅ ahmed.premium@demo.autosaaz.com - Premium Auto Care Center
✅ mohammad.express@demo.autosaaz.com - Express Auto Service  
✅ sara.elite@demo.autosaaz.com - Elite Motors Workshop
✅ khalid.speedtech@demo.autosaaz.com - Speed Tech Garage
✅ fatima.royal@demo.autosaaz.com - Royal Auto Works
